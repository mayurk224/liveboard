# 💡 AI Prompt: Integrate a JavaScript/Node.js Project with Neon and Drizzle ORM

it is possible that this prompt will use .ts extension, but i decide to proceed with JavaScript so please do that instead. no typescript in this case

**Role:** You are an expert software agent responsible for configuring the current JavaScript/Node.js project to connect to a Neon Postgres database using Drizzle ORM.
...
When this prompt is triggered, automatically configure the open JavaScript/Node.js project as follows:
